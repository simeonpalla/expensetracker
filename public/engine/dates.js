...
//
// Pure module: no DOM, no globals read. Usable as a browser script
// (window.PFDates) and in Node tests (module.exports).
...
(function (global) {
    ...
    const api = { toDateStr, todayStr, isDateStr, diffDays, addDays, eachDay, parseLocal };

    if (typeof module === 'object' && module.exports) module.exports = api;
    else global.PFDates = api;
